...
export function CreateListModal({ isOpen, onClose, userWallet, isWalletConnected }: CreateListModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-black/90 backdrop-blur-xl border-purple-500/20">
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          {step === "actions" && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-white">Configure Actions</h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {actionTypes.map((actionType) => (
                  <Button
                    ...
                    className="border-purple-500/50 text-purple-300 hover:bg-purple-500/20 bg-transparent flex flex-col gap-1 h-auto py-3"
                  >
          ...
          {step === "rewards" && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-white">Setup Rewards</h3>
          ...
          {step === "payment" && (
            <div className="space-y-6">
              <div className="text-center">
                <h3 className="text-xl font-semibold text-white mb-2">Launch Your List</h3>
                <p className="text-gray-300">Review and pay to activate your reward list</p>
              </div>
